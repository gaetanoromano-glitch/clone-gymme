...
const testimonials = [
  {
    quote:
      "Since using gymme, our pipeline has strengthened significantly, and our free trial conversions have had a major impact on our top line.",
    name: "Scott Deakins",
  ...
  {
    quote:
      "gymme has been the game-changer behind my growth from 50 to over 1900 clients.",
  ...
  {
    quote:
      "We ran our group program for the first time on gymme, and it's been the most dreamy thing ever. The amount of retention is significantly higher than before.",
    name: "Rachel Henley",
  ...
  {
    quote:
      "gymme was integrating and constantly upgrading how we can make the experience better for clients and coaches.",
    name: "Brian Foley",
  ...
  {
    quote:
      "With gymme, everything is all right there. It makes it easy to manage everything and see everything all in one platform.",
    name: "Brandon Woo",
